...
<head>
  ...
  <meta name="description" content="ศูนย์ธรรมชาติวิทยาดอยสุเทพเฉลิมพระเกียรติฯ มหาวิทยาลัยเชียงใหม่" />
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto  mb-2 mb-lg-0">
            ...
            <li class="me-lg-2"><a href="#" onclick="window.history.back()">
                <i class="fa fa-arrow-left me-2 mt-1"></i> {{__('message.home')}}</a>
            </li>
            @else
            <li class="me-lg-2"><a href="{{url('/')}}">{{__('message.home')}}</a></li>
            <li class="dropdown me-lg-2">
              <a href="{{url('about-us')}}" id="page_about" class="nav-link ">
                <span>{{__('message.aboutUs')}}</span> <i class="fas fa-chevron-down"></i>
              </a>
              <ul>
                <li><a href="{{url('about-us#box-aboutDSNC')}}">{{__('message.aboutDSNC')}}</a></li>
                <li><a href="{{url('about-us#box-vision')}}">{{__('message.vision')}}</a></li>
                <li><a href="{{url('about-us#box-mission')}}">{{__('message.mission')}}</a></li>
                <li><a href="{{url('about-us#box-core_values')}}">{{__('message.core_values')}}</a></li>
                <li><a href="{{url('about-us#box-logo')}}">{{__('message.logo_mascots')}}</a></li>
                <li><a href="{{url('empolyee')}}">{{__('message.team')}}</a></li>
              </ul>
            </li>
            <li class="dropdown me-lg-2">
              <a href="#" id="page_suthep" class="nav-link">
            ...
            // echo`
            // <li class="dropdown me-lg-2">
            //   <a href="{{url('/#box-news')}}" id="page_news" class="nav-link">
            ...
            ?>
            <li class="dropdown me-lg-2">
              <a href="{{url('services')}}" id="page_services" class="nav-link">
            ...
            // echo `
            // <!-- <li class="dropdown me-lg-2">
            //   <a href="{{url('empolyee')}}" id="page_employee" class="nav-link ">
            //     <span>{{__('message.team')}}</span> <i class="fas fa-chevron-down"></i>
            //   </a>
            //   <ul>
            //     <li><a href="{{url('empolyee#box-administrator')}}">{{__('message.administrator')}}</a></li>
            //     <li><a href="{{url('empolyee#box-staff')}}">{{__('message.staff')}}</a></li>
            //   </ul>
            // </li>
