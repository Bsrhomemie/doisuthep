...
class UserController extends Controller
{
	...
	function empolyee()
	{
		...
		$employee_list = [
			...
			[
				...
				'position_th' => 'รองผู้ช่วยหัวหน้าศูนย์ธรรมชาติวิทยาดอยสุเทพเฉลิมพระเกียรติฯ',
				'position_en' => 'Deputy Head of Doi Suthep Nature Center',
			],
			[
				'img_path' => '/images/image-5.jpg',
				'name_th' => 'ผู้ช่วยศาสตราจารย์ ดร.ปภังกร อิ่นแก้ว',
				'name_en' => 'Asst. Prof. Dr.Papangkorn Inkeaw',
				'position_th' => 'ผู้ช่วยหัวหน้าศูนย์ธรรมชาติวิทยาดอยสุเทพเฉลิมพระเกียรติฯ',
				'position_en' => 'Assistant Head of Doi Suthep Nature Center',
			],
			[
				'img_path' => '/images/image-5.jpg',
				'name_th' => 'ผู้ช่วยศาสตราจารย์ ดร. เดีย พนิตนาถ แชนนอน',
				'name_en' => 'Asst. Prof. Dr. Dia Panitnart Shannon',
				'position_th' => 'ผู้ช่วยหัวหน้าศูนย์ธรรมชาติวิทยาดอยสุเทพเฉลิมพระเกียรติฯ',
				'position_en' => 'Assistant Head of Doi Suthep Nature Center',
			],
		];
	...
	function database()
	{
		...
		foreach ($database_list as $key => $list) {
			$temp_files = '';
			$files = Picture::where('doisuthep_db_id', $list->id)->first();
			$temp_files = $files;
