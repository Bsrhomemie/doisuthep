  ...
  <div class="container pt-30px mb-5">
    <section id="box-plants" class="wow fadeInDown" >
      <div class="header-selected pt-20px">
        <h3><?php echo e(__('message.doi_suthep')); ?></h3>
      </div>
      <div class="row">
        <div class="col-12">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doisuthep\resources\views/suthep.blade.php ENDPATH**/ ?>