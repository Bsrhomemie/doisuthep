...
<?php $__env->startSection('content'); ?>
  <div id="owl-cover" class="owl-carousel cover-page owl-theme">
    <div class="item-cover" style="background-image:url(<?php echo e(asset('images/cover1.jpg')); ?>);">
      <div class="text-cover text-danger">
        <h1>Chiang Mai University</h1>
      </div>
    </div>
    <div class="item-cover" style="background-image:url(<?php echo e(asset('images/cover2.jpg')); ?>);">
      <div class="text-cover">
        <h1>นโยบายคุณภาพ</h1>
      </div>
    </div>
    <div class="item-cover" style="background-image:url(<?php echo e(asset('images/cover3.jpg')); ?>);">

    </div>
    <div class="item-cover" style="background-image:url(<?php echo e(asset('images/cover4.jpg')); ?>);">
  ...
  <div class="container">
    ...
    <section id="box-dsnc" class="wow fadeInDown" >
      <div class="header-selected pt-10px">
        <h3><?php echo e(__('message.aboutUs')); ?></h3>
        <p><i class="fa fa-bullhorn"></i><?php echo e(__('message.aboutDSNC')); ?></p>
      </div>
    </section>
    <hr class="mb-5">
  </div>
  <div class="bg-section">
    <div class="container">
      ...
      <section id="box-news" class="wow fadeInDown" >
        <div class="header-selected pt-10px">
          <h3><?php echo e(__('message.news_menu')); ?></h3>
          <p><i class="fa fa-bullhorn"></i><?php echo e(__('message.news')); ?></p>
        </div>
        <div class="row">
          <?php for($i = 0; $i < 3; $i++): ?>
            <div class="col-md-4">
              <div class="card card-box mb-3">
                <div class="highlight-hover">
                  ...
                  <div class="show-hover">
                    <a href="<?php echo e(URL::asset($list[$i])); ?>" class="me-3" data-lightbox="news"  title="ดูรูปภาพ">
                      <i class="far fa-image"></i>
                    </a>
                    <a href="<?php echo e(url('news-detail/news/1')); ?>" title="รายละเอียด">
          ...
          <div class="col-lg-12 d-flex justify-content-end">
            <a href="<?php echo e(url('news/news')); ?>" class="btn btn-main btn-sm "><i class="fa fa-arrow-right me-2"></i><?php echo e(__('message.more')); ?></a>
          </div>
        </div>
      </section>
      <section id="box-articles" class="wow fadeInDown " >
        <div class="header-selected ">
          <p><i class="fa fa-bullhorn"></i><?php echo e(__('message.articles')); ?></p>
        </div>
        <div class="row">
          <?php for($i = 0; $i < 3; $i++): ?>
            <div class="col-md-4">
          ...
          <?php endfor; ?>
          <div class="col-lg-12 d-flex justify-content-end">
            <a href="<?php echo e(url('news/articles')); ?>" class="btn btn-main btn-sm "><i class="fa fa-arrow-right me-2"></i><?php echo e(__('message.more')); ?></a>
          </div>
        </div>
      </section>
      <section id="box-souvenirs" class="wow fadeInDown mt-5" >
        <div class="header-selected">
          <p><i class="fa fa-bullhorn"></i><?php echo e(__('message.souvenirs')); ?></p>
        </div>
        <div class="col-12">
                ...
                <div class="card card-product ">
                  <div class="d-flex justify-content-center">
                    <div class="img-product">
                      <img src="<?php echo e(URL::asset('images/product1.jpg')); ?>" >
                    </div>
                  </div>
      ...
      <section id="box-vedio" class="wow fadeInDown mt-5" >
        <div class="header-selected">
          <p><i class="fa fa-bullhorn"></i><?php echo e(__('message.video')); ?></p>
        </div>
        <div class="row">
            <?php for($i=0; $i<4; $i++) { ?>
      ...
      <section id="box-join" class="wow fadeInDown mt-5 pb-5" >
        <div class="header-selected">
          <p><i class="fa fa-bullhorn"></i> <?php echo e(__('message.join')); ?></p>
        </div>
        <div class="row">
          <div class="col-12">
                  ...
                  <tr>
                    <td class="text-grey">
                      <span style="font-size:14px;">
                        ...
                        <a class="text-link" href=""><?php echo e(__('message.detail')); ?></a>
                      </span>
                    </td>
                  </tr>
                <?php  } ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doisuthep\resources\views/index.blade.php ENDPATH**/ ?>