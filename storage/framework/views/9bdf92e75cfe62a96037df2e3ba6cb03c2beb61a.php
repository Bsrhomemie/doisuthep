      ...
      <div class="header-selected pt-0">
        <h3>
          <?php if($type == 'administrator'): ?> 
            <?php echo e(__('message.administrator')); ?>

          <?php else: ?> 
            <?php echo e(__('message.staff')); ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doisuthep\resources\views/staff.blade.php ENDPATH**/ ?>