...
<html lang="en">
  ...
  <body>
    ...
    <script src="<?php echo e(asset('vendor/js/jquery-3.6.0.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>

  </body>
</html><?php /**PATH C:\xampp\htdocs\laravel\example-app\resources\views/content/layout.blade.php ENDPATH**/ ?>